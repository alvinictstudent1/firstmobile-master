...
public class Node {
    ...
    private ArrayList<comOfficer>tempOfficer;
    ...
    String officeName = new comOfficer().getOfficerName();


    public Node(int id,String getOfficerName) {
        super();
        this.id = id;
        adjacentNodes = new ArrayList<Node>();
        this.name = getOfficerName;
//        this.location = ;
    }
